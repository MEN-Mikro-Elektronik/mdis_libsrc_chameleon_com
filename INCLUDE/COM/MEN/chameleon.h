 ...
 *
 * Revision 3.34  2014/02/04 13:53:44  awerner
 * R: No support for fpga header minor Revision
 * M: Added minor Revision to CHAMELEONV2_HEADER struct
 *
 * Revision 3.33  2010/10/06 17:38:24  rlange
 * R: New FPGA device
 * M: Added WB28XX defines
 *
 * Revision 3.32  2009/01/13 10:15:59  CKauntz
 * Added SERFLASH defines
 *
 * Revision 3.31  2008/12/23 15:53:09  cs
 * R: 1. code cleanup
 *    2. add new IP cores
 * M: 1.a) removed 16Z000_SYSTEM (never appears in cham table)
 *      b) modCode "0" and devId "0xffff" used for unknown IDs
 *      c) CUSTOMER_MODULE has modCode 0x3f
 *    2. add 16Z093_AFDX, 16Z126_SERFLASH, 16Z127_GPIO
 *
 * Revision 3.30  2008/11/21 18:38:42  cs
 * R: 1. added support for 16Z037_GPIO and 16Z088_PG
 *    2. whenever an unknown ID was seen by older libs the name of "PCI INT" was shown by error
 * M: 1. added defines for 16Z037_GPIO and 16Z088_PG
 *    2. change pseudo mod ID of "PCI INT" to 0x0
 *
 * Revision 3.29  2008/06/12 11:36:21  RLange
 * Added HSSL Defines
 *
 * Revision 3.28  2008/03/31 11:31:50  DPfeuffer
 * - CHAMELEONV2_BRIDGE struct modified:
 * - '_pad' member renamed to (and used for) 'group'
 * - 'reserved' member renamed to (and used for) '*addr'
 * - CHAMELEONV2_FIND struct modified:
 * - '_pad' member renamed to (and used for) 'flags'
 * - CHAMELEONV2_FF_BRGALL define added for 'CHAMELEONV2_FIND.flags'
 *
 * Revision 3.27  2007/12/06 14:30:41  aw
 * const char *name makes problems under OS9000, no memory was allocated.
 * -> const char name[20] for OS9000
 *
 * Revision 3.26  2007/11/23 15:16:33  cs
 * added:
 *   + name string for CUSTOMER_MODULE
 *
 * Revision 3.25  2007/09/11 22:17:07  cs
 * changed:
 ...
 *
 * Revision 3.24  2007/07/11 09:57:40  CKauntz
 * changed: by default only ChameleonV2 API exported
 * added swapped CHAM_Init versions
 *
 * Revision 3.23  2007/07/04 16:09:22  cs
 * added:
 *   + G_ChamTbl[] from chameleon_strings.c
 *   + 16Z086_INTERBUS string
 *
 * Revision 3.22  2007/05/22 11:45:13  cs
 * added defines for PCI Vendor IDs for Altera and MEN
 *
 * Revision 3.21  2007/04/13 08:37:08  ts
 * Added 16Z057 (modified Z025, different IRQ handling)
 *
 * Revision 3.20  2007/02/12 17:07:20  ts
 * added new Ethernet unit 16Z087
 *
 * Revision 3.19  2007/02/07 09:46:50  aw
 * changed Revisionnumber
 *
 * Revision 3.18  2006/08/18 08:10:16  rla
 * Added EP01
 *
 * Revision 3.17  2006/08/02 10:53:52  DPfeuffer
 * CHAMELEON_16Z082_TACHO renamed to CHAMELEON_16z082_IMPULSE
 *
 * Revision 3.16  2006/08/01 11:32:10  ts
 * + CHAMELEON_16Z082_TACHO unit 0x3a
 *
 * Revision 3.15  2006/07/11 10:01:08  rla
 * Added define for Z056 SPI controller
 *
 * Revision 3.14  2006/05/12 10:02:52  RLange
 * added Z125_UART define
 *
 * Revision 3.13  2006/04/27 11:21:52  cs
 * added 16Z074, 16Z079, 16Z080, 16Z081
 *
 * Revision 3.12  2005/12/19 19:59:45  cs
 * changed define for modCode 16Z052_* (devId 0x20)
 *     16Z052_SRAM was never used and was replaced by 16Z052_GIRQ
 * added IP cores 072..077
 *
 * Revision 3.11  2005/08/31 14:52:05  kp
 * added IP cores 065..069
 *
 * Revision 3.10  2005/07/11 10:32:46  UFranke
 * changed
 *  -16Z063 from NAND to NAND_RAW
 *  -16Z053 from NAND to IDE
 *
 * Revision 3.9  2005/06/23 16:03:03  kp
 * Copyright line changed
 *
 * Revision 3.8  2005/06/06 11:31:42  kp
 * removed EM01 and EM03 defines (use em0x_cfg.h instead!)
 * + CHAMELEON_PCI_DEV_ID
 *
 * Revision 3.7  2005/06/01 14:33:27  CSchuster
 * added EM01 defines
 *
 * Revision 3.6  2005/04/29 16:51:46  ub
 * - added CHAMELEON_16Z064_ZOOM
 * - changed CHAM_VARIANT to be compatible to old libraries
 *
 * Revision 3.5  2005/04/29 14:45:30  dpfeuffer
 * Updated for Chameleon-V2 support
 *
 * Revision 3.4  2005/03/16 16:35:16  kp
 * +NAND, PWM, DMA units
 *
 * Revision 3.3  2005/02/08 12:55:12  kp
 * + FPGA header info totSize field
 *
 * Revision 3.2  2005/02/02 16:36:10  kp
 * fixed bad name for CHAMELEON_16Z031_SPI
 * + CHAMELEON_16Z023_IDENHS
 *
 * Revision 3.1  2005/01/21 15:49:41  kp
 * fixed wrong name of device ID 0x25 now 16Z044_DISP
 *
 * Revision 3.0  2005/01/21 13:42:40  kp
 * added new style defines CHAMELEON_16ZXXX_XXX
 *
 * Revision 2.12  2004/12/21 12:21:06  CSchuster
 * added CHAMELEON_ERIVAN define
 *
 * Revision 2.11  2004/12/20 08:34:54  kp
 * + FPGA header parser
 *
 * Revision 2.10  2004/12/06 11:18:45  cs
 * cosmetics for doxygen
 *
 * Revision 2.9  2004/11/22 10:49:55  ub
 * added support for IO-mapped variant
 *
 * Revision 2.8  2004/11/04 11:54:31  kp
 * added defs for new chameleon units
 * added EM03 defs
 *
 * Revision 2.7  2004/05/24 10:25:29  dpfeuffer
 * ChameleonHwName() prototype added
 *
 * Revision 2.6  2004/04/30 16:21:11  kp
 * added ChameleonFpgaCodeIdentEm04
 *
 * Revision 2.5  2004/02/06 08:41:45  kp
 * added more module codes
 * added CHAMELEON_CODES_ONLY switch
 *
 * Revision 2.4  2003/04/15 14:46:24  UFranke
 * added A015 support
 *
 * Revision 2.3  2003/03/13 14:26:26  kp
 * added ChameleonModName
 *
 * Revision 2.2  2003/01/10 14:01:25  rla
 * added define for CANGPIO test module
 *
 * Revision 2.1  2002/09/11 10:13:33  kp
 * Initial Revision
 *
 *---------------------------------------------------------------------------
...
#define CHAMELEON_GALADRIEL	0x00	/* system registers - always present */
#define CHAMELEON_SARUMAN	0x01
#define CHAMELEON_SAURON	0x02
#define CHAMELEON_GIMLI		0x03
#define CHAMELEON_LEGOLAS	0x04
#define CHAMELEON_SAM		0x05
#define CHAMELEON_GOLUMN	0x06
#define CHAMELEON_FRODO		0x07
#define CHAMELEON_BOROMIR	0x08
#define CHAMELEON_ARWEN		0x09
#define CHAMELEON_GALADRIEL_02	0x0a /* system registers - EM04A */
/*#define CHAMELEON_PCI_INT	0x0b*/
/*#define CHAMELEON_CANGPIO	0x0c*/
#define CHAMELEON_BILBO		0x10 	/* IDE UDMA */
#define CHAMELEON_EOMIR		0x11 	/* HW-CFG */
#define CHAMELEON_GIMLI_02	0x12 	/* SPI DMA */
#define CHAMELEON_ILSIDUR	0x13 	/* USB slave */
#define CHAMELEON_ARWEN_02	0x19
#define CHAMELEON_EOWIN		0x1b 	/* SMB */
#define CHAMELEON_MONTREAL	0x1c 	/* ISA bridge */
#define CHAMELEON_OTTAWA	0x1d 	/* 8254 timer */
#define CHAMELEON_WINNIPEG	0x1e 	/* binary I/O */
#define CHAMELEON_SARATOV	0x1f 	/* flash I/F */
#define CHAMELEON_SAMARA	0x20 	/* serial SRAM */
									/* cs: never used, now: global interrupt controller */
#define CHAMELEON_MOSKAU	0x21 	/* SDRAM */
#define CHAMELEON_OMSK		0x22 	/* NAND flash */
#define CHAMELEON_GALADRIEL_03	0x23 	/* system registers - EM03/EM07 */
#define CHAMELEON_TORONTO	0x24 	/* HDLC */
#define CHAMELEON_ERIVAN    0x25    /* Display Controller */
#define CHAMELEON_ANTANANARIVO  0x26    /* Interrupt controller */
#define CHAMELEON_EDMONTON  0x27 	/* Analog output */
